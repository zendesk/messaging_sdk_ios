...
@protocol ZDKClassicMessagingDelegate;
...
@interface ZDKClassicMessaging : NSObject
/// The <code>Messaging</code> singleton instance
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ZDKClassicMessaging * _Nonnull instance;)
+ (ZDKClassicMessaging * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, weak) id <ZDKClassicMessagingDelegate> _Nullable delegate;
...
@interface ZDKClassicMessaging (SWIFT_EXTENSION(MessagingSDK))
...
@interface ZDKClassicMessagingConfiguration : NSObject <ZDKConfiguration>
...
enum ZDKClassicMessagingUIEvent : NSInteger;
@class NSURL;
...
- (BOOL)messaging:(ZDKClassicMessaging * _Nonnull)messaging shouldOpenURL:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
@end

typedef SWIFT_ENUM_NAMED(NSInteger, ZDKClassicMessagingUIEvent, "MessagingUIEvent", open) {
  ZDKClassicMessagingUIEventViewDidLoad = 0,
  ZDKClassicMessagingUIEventViewWillAppear = 1,
  ZDKClassicMessagingUIEventViewDidAppear = 2,
  ZDKClassicMessagingUIEventViewWillDisappear = 3,
  ZDKClassicMessagingUIEventViewDidDisappear = 4,
  ZDKClassicMessagingUIEventViewDidLayoutSubviews = 5,
/// Fired once the Messaging UI is closed and no longer visible to the user
  ZDKClassicMessagingUIEventViewControllerDidClose = 6,
};
